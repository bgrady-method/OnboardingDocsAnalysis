...
flowchart TD
  ...
  A3 -- Yes -->|Fix Path| G2[software-installation/developer-tools.md]

  B[Service Unavailable] --> B1[IIS App Pools Started?]
  B1 -- No -->|Start Pools| G3[troubleshooting/app-pools-services.md]
  B1 -- Yes --> B2[SSL/Certs Error?]
  B2 -- Yes -->|Fix Certs| G4[certificates/README.md]
  B2 -- No --> B3[Host/DNS Issue?]
  B3 -- Yes -->|Hosts/DNS| G5[troubleshooting/host-file-list.md]

  C[DB Connection Fails] --> C1[SQL Server Running?]
  C1 -- No -->|Start Service| G6[troubleshooting/general.md]
